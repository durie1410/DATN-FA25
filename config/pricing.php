...
return [
    ...
    */
    ...
    'fines' => [
        // Phí trả muộn
        'late_return' => [
            // Phí mỗi ngày trả muộn (VNĐ)
            'daily_rate' => env('LATE_RETURN_DAILY_RATE', 5000), // 5,000 VNĐ/ngày
            
            // Thời gian chờ trước khi tính phạt (ngày)
            'grace_period' => 0, // Tính phạt ngay từ ngày đầu tiên quá hạn
            
            // Mô tả
            'description' => 'Phí trả muộn được tính từ ngày đầu tiên quá hạn, mỗi ngày quá hạn sẽ bị phạt 5,000 VNĐ.',
            
            // Công thức tính
            'formula' => 'Phí trả muộn = Số ngày quá hạn × 5,000 VNĐ/ngày',
            
            // Ví dụ
            'example' => 'Nếu trả muộn 3 ngày: 3 × 5,000 = 15,000 VNĐ',
            
            // Lưu ý
            'note' => 'Phí trả muộn được tính từ ngày đầu tiên quá hạn, không có thời gian miễn phí.',
        ],
