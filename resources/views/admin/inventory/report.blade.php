            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">Chưa có sách nào trong kho</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="card-body" style="padding: 25px;">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse($stats['current_borrows'] as $index => $borrow)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                ...
                                <td>
                                    @if($borrow->ngay_hen_tra)
                                        @if($borrow->isOverdue())
                                            <span class="badge badge-danger">{{ $borrow->ngay_hen_tra->format('d/m/Y') }}</span>
                                        @else
                                ...
                                <td>{{ $borrow->ngay_muon ? $borrow->ngay_muon->diffInDays(now()) . ' ngày' : 'N/A' }}</td>
                                <td>{{ $borrow->librarian->name ?? 'N/A' }}</td>
                                <td>
                                    @if($borrow->ngay_hen_tra && $borrow->isOverdue())
                                        <span class="badge badge-danger">Quá hạn ({{ $borrow->days_overdue }} ngày)</span>
                                    @else
