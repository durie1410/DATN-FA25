                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="condition" class="form-control" required>
                            ...
                            <option value="Tot" {{ old('condition', $inventory->condition) == 'Tot' ? 'selected' : '' }}>Tốt</option>
                            <option value="Trung binh" {{ old('condition', $inventory->condition) == 'Trung binh' ? 'selected' : '' }}>Trung bình</option>
