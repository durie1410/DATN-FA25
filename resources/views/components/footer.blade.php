<footer class="main-footer">
    <div class="footer-container">
        <div class="footer-main-content">
            ...
            <div class="footer-middle">
                <div class="footer-column">
                    <h4 class="footer-column-title">CHÚNG TÔI PHỤC VỤ</h4>
                ...
                <div class="footer-column">
                    <h4 class="footer-column-title">VỀ CHÚNG TÔI</h4>
                    <ul class="footer-links-list">
                ...
                <div class="footer-column">
                    <h4 class="footer-column-title">CHÍNH SÁCH VÀ ĐIỀU KHOẢN</h4>
                    <ul class="footer-links-list">
        ...
        <div class="footer-copyright">
            <p>Copyright © 2017 - NHÀ XUẤT BẢN XÂY DỰNG - BỘ XÂY DỰNG. All rights reserved.</p>
        </div>
    </div>
</footer>
