    ...
    <div class="row justify-content-center">
       ...
       value="{{ old('name', $user->name ?? '') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tinh_thanh" class="form-label">Tỉnh/Thành phố <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('tinh_thanh') is-invalid @enderror" 
                                              id="tinh_thanh" name="tinh_thanh" rows="3" required>{{ old('tinh_thanh') }}</textarea>
                                    @error('tinh_thanh')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="quan_huyen" class="form-label">Quận/Huyện <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('quan_huyen') is-invalid @enderror" 
                                              id="quan_huyen" name="quan_huyen" rows="3" required>{{ old('quan_huyen') }}</textarea>
                                    @error('quan_huyen')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="phuong_xa" class="form-label">Phường/Xã <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('phuong_xa') is-invalid @enderror" 
                                              id="phuong_xa" name="phuong_xa" rows="3" required>{{ old('phuong_xa') }}</textarea>
                                    @error('phuong_xa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="so_nha" class="form-label">Số nhà <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('so_nha') is-invalid @enderror" 
                                              id="so_nha" name="so_nha" rows="3" required>{{ old('so_nha') }}</textarea>
                                    @error('so_nha')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
